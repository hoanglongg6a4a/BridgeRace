    ...
    public class Benchmark01_UGUI : MonoBehaviour
    {
        ...
        IEnumerator Start()
        {
            ...
            if (BenchmarkType == 0) // TextMesh Pro Component
            {
                ...
                //m_textMeshPro.fontSharedMaterial = Resources.Load("Fonts & Materials/Anton SDF", typeof(Material)) as Material; // Same as above make sure this materialColor exists.
            ...
            else if (BenchmarkType == 1) // TextMesh
            {
                ...
                if (TextMeshFont != null)
                {
                    ...
                    //m_textMesh.renderer.sharedMaterial = m_textMesh.font.materialColor;
                }
                else
                {
